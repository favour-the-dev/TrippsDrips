...
function ProductCard({imageUrls, discountVal, productTitle, productBrand, productPrice, colors}:ProductCardProps){
    ...
    return(
        <>
            <div className="flex flex-col gap-4 items-start relative mx-auto max-w-[400px] md:max-w-[250px] max-h-[400px] h-full w-full cursor-pointer">
                <div className="w-full h-full relative group">
                    ...
                    <div className="w-full h-[300px] group-hover:border-2
                    ...
                    <div className="w-fit bg-white p-3 rounded-full duration-300 ease-in-out absolute opacity-0 bottom-0 right-1 group-hover:opacity-100  group-hover:bottom-[10%] text-xl text-gray-700"><FaShoppingBag/></div>
                </div>
